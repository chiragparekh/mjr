...
$q = "select p.name as name,p.id as pid,p.image_path as image_path,sc.name as sub_cat_name from tbl_product p inner join tbl_sub_category sc on p.sub_category_id=sc.id where 1=1";
if ($minWeight != "-1")
