...
<?php include_once "includes/rightside.php";?>    
    ...
    <div class="wrapper">
        ...
        ?>
        <form enctype="multipart/form-data" style="margin-top:20px;" action="update-product2.php" method="post" class="form" id="validate">
        	...
        	<fieldset>
                <div class="widget" style="margin-top: 20px;">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">                       
                            <input type="text" value="<?php echo $r['weight'];?>" id="txtWeight" name="txtWeight" class="validate[required]" />
                        </div><div class="clear"></div>
                    </div>
                    <div class="formRow">
